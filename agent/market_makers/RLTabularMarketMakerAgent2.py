...
class RLTabularMarketMakerAgent2(TradingAgent):
    """
    Tabular SARSA/Q-learning market maker with cubic inventory penalty in reward:
    reward = ΔMTM - lambda * |inventory|^3

    State/action layout matches RLTabularMarketMakerAgent for fair comparison.
    """
    ...
    def receiveMessage(self, currentTime, msg):
        ...
        if self.state == 'AWAITING_SPREAD' and msg.body['msg'] == 'QUERY_SPREAD':
            ...
            if not (bid and ask):
                log_print("{}: missing spread at {}, skipping quote", self.name, currentTime)
            ...
            reward = mtm - self.last_mtm - self.inventory_penalty * (abs(inv) ** 3)
